    ...
    <div className="w-full flex justify-center">
      ...
      >
        <div className="mx-auto flex items-center justify-between p-5 px-6 md:px-10 lg:px-16 relative">
          ...
          <button
            onClick={() => router.push("/")}
            className="logo font-bold p-5 text-4xl md:text-4xl absolute left-1/2 -translate-x-1/2 bg-gradient-to-r from-indigo-300 to-purple-100 bg-clip-text text-transparent"
          >
            Yoga Delight
          </button>
